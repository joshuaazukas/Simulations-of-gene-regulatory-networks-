...
@time begin # Benchmarking, can remove. Typically code runs in ~2-3 minutes for 10k simulations
    ...
    CSV.write("C://Users//Strey Lab//Desktop//Github Reps//Outputs//12_15_23//parameters.csv", param_df); # Path to save the .CSV of parameters of each simulation
    ...
    CSV.write("C://Users//Strey Lab//Desktop//Github Reps//Outputs//12_15_23//simulated_traces.csv", df_gfp_values, bufsize=100000000); # Path to save the .CSV of the GFP time-traces of each simulation
